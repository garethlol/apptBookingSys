...
namespace ABS_1.Members
{
    public partial class AvailabilityChecker : System.Web.UI.Page
    {
        ...
        protected void Calendar1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (subString2[1] == "1" || subString2[1] == "2" || subString2[1] == "3" || subString2[1] == "4" || subString2[1] == "5" || subString2[1] == "6"
                || subString2[1] == "7" || subString2[1] == "8" || subString2[1] == "9")
            {
                subString2[1] = "0" + subString2[1];

            }

            // text = subString2[3] + "-" + subString2[2] + "-" + subString2[1];

            text = subString2[3] + "-" + subString2[2] + "-" + subString2[1] + " 07:00:00.000";
